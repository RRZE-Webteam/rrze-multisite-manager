    ...
    <div class="rrze-msm-page-shell">
        ...
        <section class="rrze-msm-widget rrze-msm-widget-span-12 rrze-msm-site-details-search">
            <header class="rrze-msm-widget-header">
                <h2><?php echo esc_html__('Theme auswählen', 'rrze-multisite-manager'); ?></h2>
                <p><?php echo esc_html__('Suche nach dem Namen eines Themes und öffne danach die gewünschte Detailansicht.', 'rrze-multisite-manager'); ?></p>
            </header>
