<section class="rrze-msm-widget <?php echo esc_attr($widget_classes); ?>" data-widget-id="<?php echo esc_attr($widget_id); ?>">
    ...
    <div class="rrze-msm-growth-chart">
        <?php foreach ($items as $item) { ?>
            <?php $height = $max_value > 0 ? (int)round((((int)$item['value']) / $max_value) * 100) : 0; ?>
            <div class="rrze-msm-growth-item">
                <div class="rrze-msm-growth-column">
                    <span class="rrze-msm-growth-fill" style="height: <?php echo esc_attr((string)$height); ?>%;"></span>
                </div>
