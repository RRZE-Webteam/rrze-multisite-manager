...
<section class="rrze-msm-widget <?php echo esc_attr($widget_classes); ?>" data-widget-id="<?php echo esc_attr($widget_id); ?>">
    ...
    <?php echo wp_kses_post($this->renderSiteOverviewTable($sites, ['table_id' => $widget_id, 'default_per_page' => $default_per_page ?? 10, 'sort_key' => 'registered', 'sort_direction' => 'desc'])); ?>
</section>
